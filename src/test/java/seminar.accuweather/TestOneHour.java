...
public class TestOneHour extends AbstractTest{

    private static final Logger logger
            = LoggerFactory.getLogger(TestOneHour.class);
    ...
    void get_shouldReturn200() throws IOException, URISyntaxException {
        ...
        logger.debug("Формирование мока для GET /forecasts/v1/hourly/1hour/27103");
        stubFor(get(urlPathEqualTo("/forecasts/v1/hourly/1hour/27103"))
        ...
        HttpGet request = new HttpGet(getBaseUrl()+"/forecasts/v1/hourly/1hour/27103");
        ...
        verify(1, getRequestedFor(urlPathEqualTo("/forecasts/v1/hourly/1hour/27103")));
