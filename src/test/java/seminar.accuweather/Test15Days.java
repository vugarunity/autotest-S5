...
public class Test15Days extends AbstractTest {

    private static final Logger logger
            = LoggerFactory.getLogger(Test15Days.class);
    ...
    void getAdminAreas_shouldReturn401ForUnauthorizedAccess() throws IOException, URISyntaxException {
        ...
        bodyError.setReference("/forecasts/v1/daily/15day/294459");

        stubFor(get(urlPathEqualTo("/forecasts/v1/daily/15day/294459"))
                .willReturn(aResponse()
                        .withStatus(401)
                        .withBody(mapper.writeValueAsString(bodyError))));

        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            HttpGet request = new HttpGet(getBaseUrl() + "/forecasts/v1/daily/15day/294459");
            ...
            assertEquals("/forecasts/v1/daily/15day/294459", errorResponse.getReference());
        }
    }
